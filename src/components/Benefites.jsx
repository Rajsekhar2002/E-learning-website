...
const Benefites = () => {
  return (
    <section className='section'>
        ...
        className="container">
            {/* Title  */}
            <Title title="Benefits" text="Lorem ipsum dolor sit amet consectetur. Tempus tincidunt 
            ...
            lg:grid-cols-3 mt-12 lg:mt-16">
                {benefitItems.map(item =>(
                    ...
                    rounded-xl">
                        ...
                        {/* button  */}
                        <button className='mt-auto ml-auto border border-white-95 

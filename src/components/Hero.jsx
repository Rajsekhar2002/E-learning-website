     ...
     className='container'>
        ...
        <div className='mt-[50px] md:mt-20 text-center'>
            ...
            <div className="relative max-w-max mx-auto pt-8 pl-8">
                ...
                <motion.div variants={variants.fadeInUp} className="flex items-center bg-white-99 border 
                border-white-95 rounded-lg p-3.5 justify-center
                gap-2.5 max-w-max mx-auto flex-wrap text-center">
                    <span>
                        <img src="/images/shape-2.png" alt="shape title" width={48} height={48} />
                    </span>
            ...
            <motion.p 
            variants={variants.fideInUp}
            className='text-2xl font-medium mt-4 md:text-[28px]'>with Online Design and Development Courses.</motion.p>
            <motion.p variants={variants.fadeInUp} >Learn from Industry Experts and Enhance Your Skills.</motion.p>

            {/* Btn wraper */}
            <div className="flex items-center justify-center gap-3 mt-12 flex-wrap">
                <motion.button variants={variants.fadeInUp}
                className='primary-btn max-sm:w-[80%]'>Explore Courses</motion.button>
                <motion.button variants={variants.fideInUp}
                className='secondary-btn max-sm:w-[80%] '> View Pricing</motion.button>
            </div>
            ...
            <motion.div variants={variants.fadeIn}
             className=" mt-8 lg:mt-[100px] relative overflow-hidden">
                ...
                <div className="absolute top-0 left-0 bg-gradient-to-r
                 from-white-97 via-white-97/80 to-transparent w-4 h-full z-10 pointer-events-none "/>
        ...
        className='relative rounded-xl overflow-hidden mt-10 md:mt-14 
